        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            ...
            <div className=" space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                <div className="flex flex-col max-w-md p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    <h3 className="mb-4 text-2xl font-semibold">Corporate Company Offical Website</h3>
                ...
                <SVG  caseValue='case7' name="Tick" />
                    ...
                    <Link target="_blank"to="https://tharacart.netlify.app/" className="text-white bg-purple-600 hover:bg-purple-700 focus:ring-4  focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">LIVE DEMO</Link>

                    <Link target="_blank"to="https://github.com/ll00lll00l0l/tharafrontend.git" className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">GITHUB LINK</Link>
                    </div>
                ...
                <SVG  caseValue='case8' name="loading" />
                    ...
                    <div className='flex gap-8'>
                    <Link target="_blank"to="https://mobile-econ22.vercel.app"className="text-white bg-purple-600 hover:bg-purple-700 focus:ring-4  focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">LIVE DEMO</Link>

                    <Link target="_blank"to="https://github.com/ll00lll00l0l/credot.git" className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">GITHUB LINK</Link>
                    </div>                
                    </div>
